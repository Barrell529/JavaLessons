...
public class Main {
    ...
    public static int[] arrSumElements(String[][] arr, int maxArrIjDim) {
        ...
        public static void main (String[]args){
            ...
            if (sum[1] == 1){
                System.out.println("Ошибка в вычислениях!!! Сумма эелементов массива до момента возникновения ошибки = " + sum[0]);
            }
